	...
	public void init() {
		try {
			this.travelRepository.save(Travel.builder().id("a").id_account(1).id_user(1).id_scooter(1000)
					...
					.km(BigDecimal.valueOf(45)).cost(BigDecimal.valueOf(5000)).paused(false).build());

			this.travelRepository.save(Travel.builder().id("b").id_account(2).id_user(2).id_scooter(1001)
					.start_date(LocalDateTime.of(2023, 06, 16, 0, 0)).ending_date(null).pause_time(0)
					.km(BigDecimal.valueOf(12)).cost(BigDecimal.valueOf(1500)).paused(false).build());

			this.travelRepository.save(Travel.builder().id("c").id_account(3).id_user(3).id_scooter(1002)
					.start_date(LocalDateTime.of(2023, 06, 17, 0, 0)).ending_date(null).pause_time(20)
					.km(BigDecimal.valueOf(55)).cost(BigDecimal.valueOf(6000)).paused(false).build());
			
			this.travelRepository.save(Travel.builder().id("d").id_account(1).id_user(1).id_scooter(1003)
					.start_date(LocalDateTime.of(2023, 06, 17, 0, 0)).ending_date(null).pause_time(20)
					.km(BigDecimal.valueOf(55)).cost(BigDecimal.valueOf(6000)).paused(false).build());
			
			this.travelRepository.save(Travel.builder().id("e").id_account(2).id_user(2).id_scooter(1004)
					.start_date(LocalDateTime.of(2023, 06, 17, 0, 0)).ending_date(null).pause_time(20)
					.km(BigDecimal.valueOf(55)).cost(BigDecimal.valueOf(6000)).paused(false).build());
			
			this.travelRepository.save(Travel.builder().id("f").id_account(3).id_user(3).id_scooter(1005)
					.start_date(LocalDateTime.of(2023, 06, 17, 0, 0)).ending_date(null).pause_time(20)
					.km(BigDecimal.valueOf(55)).cost(BigDecimal.valueOf(6000)).paused(false).build());
